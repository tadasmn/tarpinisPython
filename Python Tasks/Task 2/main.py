...
def getUserAverageAge(users):
  ...
  for x in users:
    sum_age += x["age"]
  average_age = sum_age / total_users
  return int(average_age)

print(f"Amziaus vidurkis:", getUserAverageAge(users))
...
def getUsersNames(users):
  for x in users:
    only_names.append(x["name"])
    only_names.sort()
  return only_names

print(f"surikiuoti names abeceles tvarka:", getUsersNames(users))
